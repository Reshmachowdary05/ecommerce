...
export default function Home() {
  ...
  function addToCart(productId){
    ...
    axios.post("https://ecommerce-2gfw.onrender.com/api/cart/add",
      ...
      .then(res=>{
        if(res.status==200){
          ...
          Swal.fire({
  title: "Good job!",
  text: "You are added to cart successfully",
  icon: "success"
});
          navigate("/cart")
        }
  ...
  async function fetchProducts() {
    axios.get("https://ecommerce-2gfw.onrender.com/api/product")
      .then((res) => {
